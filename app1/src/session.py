...
class SessionManager:
    def __init__(self, secret: str, cookie_secure: bool = False, cookie_domain: str = "", cookie_name: str = "app1_session") -> None:
        self.serializer = URLSafeSerializer(secret_key=secret, salt="app1-session")
